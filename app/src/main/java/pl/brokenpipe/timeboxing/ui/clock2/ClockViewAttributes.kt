 ...
 */
data class ClockViewAttributes(
    val handColor: Int,
    val backgroundColor: Int,
    val primaryFaceColor: Int,
    val secondaryFaceColor: Int,
    val dividersColor: Int,
    val handVisibility: Boolean,
    val faceVisibility: Boolean,
